...
# Parsing + Configuration Script – LTC2 - Rev. A

This **Parsing + Configuration** script is designed for the **LTC2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – LTC2 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **LTC2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
